...
exports.useEditReplyMutation = void 0;
...
function useEditReplyMutation(replyId, obj) {
    ...
    var edit = client_1.useMutation(graphql_1.EDIT_REPLY_MUTATION, {
        variables: values,
        update: function (proxy, result) {
            ...
            data.getReply = __assign(__assign({}, data.getReply), result.data.editReply);
            proxy.writeQuery({
                query: graphql_1.FETCH_REPLY_QUERY,
                variables: { replyId: replyId },
                data: data
...
exports.useEditReplyMutation = useEditReplyMutation;
