...
export default function Answer({
    ...
    const answer = useGetQuery(id, "answer");
    ...
    /// answerUser
    const [answerUser, setAnswerUser] = useGetUserQuery();
    ...
    /// upvote | downvote
    const upvoteAnswer = useVoteMutation(id, "answer", "upvote");
    const downvoteAnswer = useVoteMutation(id, "answer", "downvote");
    ...
    const {
        ...
        editCallback,
        values,
    } = useEditMutation(id, answer, "answer");

    const deleteAnswer = useDeleteMutation(id, "answer", postId, "post");
    ...
    } = useCreateMutation(id, "answer", "comment");
